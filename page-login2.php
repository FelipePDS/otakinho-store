...
<head>
  ...
  <title>Loja Otakinho - Login</title>
      ...
      <header id="header" class="fixed-top d-flex align-items-center header-transparent">
            ...
            <nav class="nav-menu d-none d-lg-block">
              <ul>
                ...
                <li class="active"><a href="#container">Login</a></li>
        ...
        <?php if (isset($_SESSION['user-inexistent'])): ?>
          ...
          <div id="login">
            ...
            <form action="login.php" method="POST">
              ...
              <fieldset class="clearfix">
                ...
                <?php if (isset($_SESSION['user-inexistent'])): ?>
                  <script>
                      document.querySelectorAll('p input')[0].value = '<?php echo $_SESSION["email"]; ?>';
                      document.querySelectorAll('p input')[1].value = '<?php echo $_SESSION["passwordUser"]; ?>';
                  </script>
                <?php
                  endif;
                  unset($_SESSION['user-inexistent']);
                ?>
            ...
            <p>Não tem conta? &nbsp;<a href="page-inscription2.php">Cadastrar-se</a><span class="fontawesome-arrow-right"></span></p>
