  ...
  <div class="page-home-container">
    ...
    <section id="hero">
      ...
      <div class="card text-white bg-dark mb-3" data-aos="zoom-in" style="padding: 2rem;">
          <div class="card-header bg-dark text-white" style="padding-top: 0px !important;"><b>Produtos Otakinhos</b></div>
            ...
            <table class="table table-striped table-dark" style="opacity: 90%;">
                ...
                <tbody>
                    <?php
                        ...
                        foreach ($conexao -> query($queryProducts) as $lineResult) {
                            include('../conecta.php');

                            $idProduct = $lineResult['idProduct'];
                            $nameProduct = $lineResult['name'];
                            $priceProduct = $lineResult['price'];
