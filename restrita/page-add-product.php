...
<head>
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <style>
    ...
    #hero {
      background: url("../assets/images/bgAnime3.jpg") fixed;
...
<body class="page-home">
  <div class="page-home-container">
    ...
    <section id="hero">
      ...
      <div class="card text-white bg-dark mb-3" data-aos="zoom-in" style="padding: 2rem;">
          <div class="card-header bg-dark text-white" style="padding-top: 0px !important;">Adicione Um Produto Otakinho</div>
          <div class="card-body" style="width: 100%; display: flex; align-items: center !important; justify-content: center !important; padding: 0px !important;">
            ...
            <form method="post" action="add_product.php" enctype="multipart/form-data" class="form-horizontal was-validated" id='formAction'>
                ...
                <div class="products">
                    <div class="form-row product-field" style="display: flex; align-items: center !important; justify-content: center !important; margin-bottom: .6rem; position: relative !important;">
                        <div class="col-md-4 mb-3" style="padding-left: 0px !important;">
                          ...
                          <div class="input-group">
                              ...
                              <input type="text" name="name[]" class="form-control" id="validationDefault01" placeholder="Produto" style="background-color: #3a4147; color: #606468 !important; border-color: #2c3135 !important;" required>
                          </div>
                        </div>
                        <div class="col-md-4 mb-3" style="padding-left: 0px !important;">
                          <label for="validationDefaultUsername" style="color: #606468">Preço</label>
                          <div class="input-group">
                              <div class="input-group-prepend">
                              ...
                              <input type="text" name="price[]" class="form-control" id="validationDefault02" placeholder="Preço" style="background-color: #3a4147; color: #606468 !important; border-color: #2c3135 !important;" required>
                          </div>
                        </div>
                  ...
                  <div class="col-auto">
                    <button type="submit" class="btn btn-primary mb-2" style="margin: 0px !important; background-color: #1acc8d; border-color: none !important; font-size: 1.3rem;">Cadastrar <i class="animated-button fa fa-cart-arrow-down"></i></button>
                  </div>
  ...
  <script>
      ...
      buttonAddField.addEventListener('click', () => {
        ...
        newFieldProducts.querySelectorAll('input').forEach(function(field) {
          field.value = '';
        })
