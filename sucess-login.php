<?php
    include('verify_sucess-login.php');
?>
  ...
  <body id="page-login" class="page-login" onload="move()">
    ...
    <div class="mascara">
        ...
        <div data-aos="zoom-out">
            <h1>Bem vindo de volta <span><?php echo $_SESSION['name']; ?></span>!</h1>
            <img src="assets/images/db4.gif" alt="Animação de tela de carregamento Dragon Ball">
        </div>
